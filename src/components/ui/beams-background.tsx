...
export function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
            ...
            // Enhanced gradient with Amande colors
            gradient.addColorStop(0, `hsla(${beam.hue}, 65%, 88%, 0)`);
            gradient.addColorStop(
                0.1,
                `hsla(${beam.hue}, 65%, 88%, ${pulsingOpacity * 0.5})`
            );
            gradient.addColorStop(
                0.4,
                `hsla(${beam.hue}, 65%, 88%, ${pulsingOpacity})`
            );
            gradient.addColorStop(
                0.6,
                `hsla(${beam.hue}, 65%, 88%, ${pulsingOpacity})`
            ...
            gradient.addColorStop(1, `hsla(${beam.hue}, 65%, 88%, 0)`);
    ...
    return (
        <div
            className={cn(
                "relative min-h-screen w-full overflow-hidden monster-dark",
                className
            )}
        >
            <canvas
            ...
            <motion.div
                className="absolute inset-0 monster-dark/10"
                animate={{
